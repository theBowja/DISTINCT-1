...
config.db.password 	= process.env.RDS_PASSWORD || 'mario'; // edit the part after the '||'
config.db.port 	   	= process.env.RDS_PORT     || 3306;
config.db.dbname   	= process.env.RDS_DB_NAME  || 'distincttest'; // edit the part after the '||'
